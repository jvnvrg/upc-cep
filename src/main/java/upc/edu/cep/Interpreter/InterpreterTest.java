...
import upc.edu.cep.RDF_Model.event.ComplexTemporalEvent;
...
//        having sum(b.price) > 100
        ...
        serviceOrder.setEventName("ServiceOrder");
        serviceOrder.addAttribute(custIda);
        serviceOrder.addAttribute(name);

        custIda.setEvent(serviceOrder);
        name.setEvent(serviceOrder);
        ...
        productOrder.setEventName("ProductOrder");
        productOrder.addAttribute(price);
        productOrder.addAttribute(custIdb);

        price.setEvent(productOrder);
        custIdb.setEvent(productOrder);
